...
export default function LiveBoard() {
  ...
  return (
    <div className="h-screen flex flex-col bg-theme-bg text-theme-main overflow-hidden w-full absolute top-0 left-0 z-50">
      {/* Header */}
...
function FlightRow({ flight, getStatusLabel }: { flight: Flight; getStatusLabel: (s: string) => string }) {
  ...
  useEffect(() => {
    const calculateTime = () => {
      ...
      // Si la hora programada ya pasó hace más de 12 horas, probablemente es del día siguiente
      // (asumiendo que el FIDS muestra vuelos cercanos)
  ...
  return (
    ...
    >
      <div className="flex flex-col w-32 shrink-0">
        ...
        {timeRemaining && (
          <div className="text-[11px] text-theme-accent font-bold mt-1">
            ({timeRemaining})
          </div>
        )}
      </div>
